...
$sTableID = "tbl_kit_mailing_undelivered"; // ID �������
...
$cData = new CKitMailingUndelivered;
// ******************************************************************** //
//                ��������� �������� ��� ���������� ������              //
// ******************************************************************** //
...
while($arRes = $rsData->NavNext(true, "f_", false)) {
    $editUrl = "kit_mailing_undelivered_detail.php?ID=".$f_ID."&lang=".LANG;
    ...
    if($POST_RIGHT>="W") {           
         ...
         //$row->AddViewField("EMAIL_TO", '<a href="kit_mailing_undelivered_detail.php?ID='.$f_ID.'&amp;lang='.LANG.'" title="'.GetMessage("subscr_upd").'">'.$f_EMAIL_TO.'</a>');
...
if($POST_RIGHT>="W") {
    ...
    $aContext = array(
        array(
            ...
            "ICON" => "btn_new",
            "LINK" => "kit_mailing_undelivered_import.php?lang=".LANG,
