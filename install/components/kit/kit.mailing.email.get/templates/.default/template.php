...
<div class="kit_reg_pannel<?if($_COOKIE['kit_reg_pannel_open'] == "N"):?> <?else:?> open<?endif;?>" id="kit_reg_pannel">
    <div class="f-sub-close toClose" onclick="KitPannelSlide()">
    ...
    <div class="reg_bottom_pannel_in_wrap">                    
        <div class="bottom_pannel_in">
            ...
            <form id="kit_reg_panel_form" method="post" action="#">
...
#kit_reg_pannel .reg_bottom_pannel_in_wrap {
    padding-top: 8px;
}
.f-sub-close {
    background-color: #<?=$arParams["COLOR_PANEL"]?>;
