...
/**
 * Класс для работы с таблицей b_sotbit_mailing_message, которая хранит параметры сообщений, созданных для отправки.
 *
 * Поля таблицы:
 * <ul>
...
class CSotbitMailingMessage
{
    public function Add($arFields)
    {
        ...
        $strSql = "INSERT INTO b_sotbit_mailing_message(" . $arInsert[0] . ") " . "VALUES(" . $arInsert[1] . ")";
