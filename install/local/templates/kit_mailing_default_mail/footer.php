    ...
    <tr style="background-color: #89cbf5; border-top: 1px solid #d3dcdd">
        ...
        <td style="vertical-align: top; padding-top: 20px; padding-bottom: 20px; font-size: 16px; font-family:Trebuchet MS; color: #FFFFFF">
            ...
            <p style="text-align:center;">
                <a style="color: #FFFFFF" href="<?=$serverName?>?MAILING_MESSAGE=#MAILING_MESSAGE#&MAILING_UNSUBSCRIBE=#MAILING_UNSUBSCRIBE#&utm_source=newsletter&utm_medium=email&utm_campaign=kit_mailing_#MAILING_EVENT_ID#"><?=getMessage('TEMPLATE_FOOTER_UNSUBSCRIBE')?></a>
            </p>
        </td>
        <td></td>
    </tr>
