...
$sTableID = "tbl_kit_mailing_categories"; // ID �������
...
$cData = new CKitMailingCategories;

$cDataMessage = new CKitMailingSubscribers;
// ******************************************************************** //
//                ��������� �������� ��� ���������� ������              //
// ******************************************************************** //
...
if($POST_RIGHT=="W")
{
  ...
  if(is_array($FIELDS)) { 
      ...
      foreach($FIELDS as $ID=>$arFields)
      {
        ...
        if($res = CKitMailingCategories::GetByID($ID)) {
...
while($arRes = $rsData->NavNext(true, "f_")) {
    $editUrl = "kit_mailing_categories_detail.php?ID=".$f_ID."&lang=".LANG;
...
if($POST_RIGHT>="W") {
    ...
    $aContext = array(
        array(
            ...
            "LINK" => "kit_mailing_categories_detail.php?lang=".LANG,
