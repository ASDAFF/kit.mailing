...
class sotbit_mailing extends CModule
{
    ...
    function DoInstall()
    {
        ...
        if ($_REQUEST['step'] == 1) {
            if ($_SERVER['SERVER_NAME']) {
                $_2144314965 = $_SERVER['SERVER_NAME'];
            } elseif ($_SERVER['HTTP_HOST']) {
                $_2144314965 = $_SERVER['HTTP_HOST'];
            }
            $_1490075189 = '';
            $_1180343253 = \CUpdateClient::GetUpdatesList($_1490075189);
            $_1451728565 = array(
                'ACTION' => 'ADD',
                'SITE' => $_2144314965,
                'KEY' => md5('BITRIX' . \CUpdateClientPartner::GetLicenseKey() . 'LICENCE'),
                'LICENSE' => $_1180343253['CLIENT'][0]['@']['LICENSE'],
                'MODULE' => self::MODULE_ID,
                'NAME' => $_REQUEST['Name'],
                'EMAIL' => $_REQUEST['Email'],
                'PHONE' => $_REQUEST['Phone'],
                'BITRIX_DATE_FROM' => $_1180343253['CLIENT'][0]['@']['DATE_FROM'],
                'BITRIX_DATE_TO' => $_1180343253['CLIENT'][0]['@']['DATE_TO'],
            );
            $_490739411 = array('http' => array(
                'method' => 'POST',
                'header' => 'Content-Type: application/json; charset=utf-8',
                'content' => json_encode($_1451728565))
            );
            $_93126397 = stream_context_create($_490739411);
            $_166985966 = file_get_contents('https://www.sotbit.ru:443/api/datacollection/index.php', 0, $_93126397);
    ...
    function InstallDB($_1362428416 = array())
    {
        ...
        RegisterModuleDependences('main', 'OnBuildGlobalMenu', self::MODULE_ID, 'CSotbitMailingHelp', 'OnBuildGlobalMenuHandler');
        RegisterModuleDependences('main', 'OnEpilog', self::MODULE_ID, 'CSotbitMailingHelp', 'OnEpilog');
    ...
    function UnInstallDB($_1362428416 = array())
    {
        ...
        UnRegisterModuleDependences('main', 'OnEpilog', self::MODULE_ID, 'CSotbitMailingHelp', 'OnEpilog');
        UnRegisterModuleDependences('main', 'OnBuildGlobalMenu', self::MODULE_ID, 'CSotbitMailingHelp', 'OnBuildGlobalMenuHandler');
