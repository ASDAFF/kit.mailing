...
$vk = \Bitrix\Main\Config\Option::get("kit.missshop", "LINK_VK", "");
$fb = \Bitrix\Main\Config\Option::get("kit.missshop", "LINK_FB", "");
$tw = \Bitrix\Main\Config\Option::get("kit.missshop", "LINK_TW", "");
$gl = \Bitrix\Main\Config\Option::get("kit.missshop", "LINK_GL", "");
?>
                    </td>
                </tr>
            </table>
                                            ...
                                            <td width="100%">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:0; padding:0">
                                                    <tr >
                                                        <td width="100%">
                                                            <![endif]-->
                                                            <span style="font: 15px 'Proxima Nova', Arial, sans-serif;color: #000000;font-weight: bold;text-transform:uppercase;text-decoration: none;line-height:51px;display: block; -webkit-text-size-adjust:none;"><font color="#000000" size="3" face="Proxima Nova, Arial, sans-serif">��������</font></span>
                                                            <!--[if gte mso 9]>
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:0; padding:0">
                                                    <tr >
                                                        <td width="100%">
                                                            <![endif]-->
                                                            <a href="mailto:<?if($email) echo $email; else CMain::IncludeFile('/local/templates/kit_mailing_minimal/email.php');?>" target="_blank" style="font: 16px 'Proxima Nova', Arial, sans-serif;color: #212121;text-decoration: none;line-height:30px;padding-bottom: 13px;display: block; -webkit-text-size-adjust:none;">
                                                                <font color="#212121" size="3" face="Proxima Nova, Arial, sans-serif">
                                                                    <?if($email) echo $email; else CMain::IncludeFile('/local/templates/kit_mailing_minimal/email.php');?>
                                                                </font>
                                                            </a>
                                                            <!--[if gte mso 9]>
                                                        </td>
                                                ...
                                                <div style="padding-top: 26px;">
                                                    <a href="<?=$vk?>" target="_blank" style="font-weight: normal;text-decoration: none;cursor: pointer;">
                                                        <font color="#000000" face="Arial" size="2">
                                                            <img src="<?=$serverName?>/local/templates/kit_mailing_minimal/img/mail_vk.png" alt="vk" width="30" height="31" style="border: 0; outline:none; text-decoration:none;">
                                                        </font>
                                                    </a> &nbsp;
                                                    <a href="<?=$fb?>" target="_blank" style="font-weight: normal;text-decoration: none;cursor: pointer;">
                                                        <font color="#000000" face="Arial" size="2">
                                                            <img src="<?=$serverName?>/local/templates/kit_mailing_minimal/img/mail_fb.png" alt="facebook" width="30" height="31" style="border: 0; outline:none; text-decoration:none;">
                                                        </font>
                                                    </a> &nbsp;
                                                    <a href="<?=$tw?>" target="_blank" style="font-weight: normal;text-decoration: none;cursor: pointer;">
                                                        <font color="#000000" face="Arial" size="2">
                                                            <img src="<?=$serverName?>/local/templates/kit_mailing_minimal/img/mail_tw.png" alt="twitter" width="30" height="31" style="border: 0; outline:none; text-decoration:none;">
                                                        </font>
                                                    </a> &nbsp;
                                                    <a href="<?=$gl?>" target="_blank" style="font-weight: normal;text-decoration: none;cursor: pointer;">
                                                        <font color="#000000" face="Arial" size="2">
                                                            <img src="<?=$serverName?>/local/templates/kit_mailing_minimal/img/mail_gl.png" alt="google" width="30" height="31" style="border: 0; outline:none; text-decoration:none;">
                                                        </font>
                                                    </a> &nbsp;
                                                </div>
                                            </td>
                                ...
                                <td align="center">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:0; padding:0">
                                        <tr>
                                            <td width="100%">
                                                <![endif]-->
                                                <a href="<?=$serverName?>?utm_source=newsletter&utm_medium=email&utm_campaign=kit_mailing_#MAILING_EVENT_ID#&MAILING_MESSAGE=#MAILING_MESSAGE#&MAILING_UNSUBSCRIBE=#MAILING_UNSUBSCRIBE#" target="_blank" style="font: 12px 'Proxima Nova', Arial, sans-serif;color: #ffffff;text-decoration-color: #898989;line-height:30px;display: block; -webkit-text-size-adjust:none;">
                                                    <font color="#ffffff" size="2" face="Proxima Nova, Arial, sans-serif">
