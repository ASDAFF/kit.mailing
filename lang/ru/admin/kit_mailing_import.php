...
$MESS[$module_id."_PAGE_TITLE"] = "Импорт подписчиков";
...
$MESS[$module_id."_edit10"] = "Импорт подписчиков";  

$MESS[$module_id."_OPTION_DEF_NANE"] = "Настройки";
$MESS[$module_id."_OPTION_CATEGORIES"] = "Группа подписчиков"; 
$MESS[$module_id."_OPTION_TYPE"] = "Тип импорта"; 
$MESS[$module_id."_OPTION_SETTINGS"] = "Фильтрация подписчиков"; 


$MESS[$module_id."_CATEGORIES_ID_TITLE"] = "Выберите группу импорта";
$MESS[$module_id."_IMPORT_TYPE_TITLE"] = "Тип импорта";


$MESS[$module_id."_RESULT_IMPORT_MESSAGE"] = "Импорт прошел успешно:<br />
Добавлно новых подписчиков: #NEW# <br />
Обновлены текущие подписчики: #OLD# 
";
