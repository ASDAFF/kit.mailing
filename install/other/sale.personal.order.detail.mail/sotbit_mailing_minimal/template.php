                                ...
                                <tr width="100%">
                                    ...
                                    foreach ($arParams["CUSTOM_SELECT_PROPS"] as $headerId):
                                        ...
                                        if($headerId == "NAME"):
                                            ...
                                            if($hasLink):
                                                ?><a href="<?=$prod["DETAIL_PAGE_URL"]?>?utm_source=newsletter&utm_medium=email&utm_campaign=kit_mailing_#MAILING_EVENT_ID#&MAILING_MESSAGE=#MAILING_MESSAGE#" target="_blank" class="orderList" style="text-decoration: none;"><?
                                            endif;
                                            ?><?=$prod["NAME"]?><?
                                            if($hasLink):
                                                ?></a><?
                                        ...
                                        elseif($headerId == "PICTURE"):
                                            ...
                                            if($hasLink):
                                                ?><a href="<?=$prod["DETAIL_PAGE_URL"]?>?utm_source=newsletter&utm_medium=email&utm_campaign=kit_mailing_#MAILING_EVENT_ID#&MAILING_MESSAGE=#MAILING_MESSAGE#" target="_blank"><?
                                            endif;
                                            if($prod['PICTURE']['SRC']):
