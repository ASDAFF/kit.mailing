create table  IF NOT EXISTS b_kit_mailing_event (
...
CREATE TABLE  IF NOT EXISTS b_kit_mailing_section
(
...
create table  IF NOT EXISTS b_kit_mailing_message (
    ID int not null auto_increment,
...
create table  IF NOT EXISTS b_kit_mailing_message_text (
    ID int not null auto_increment,
    ID_MESSEGE int(18),
    SUBJECT text null,
...
create table  IF NOT EXISTS b_kit_mailing_message_template (
    ID int not null auto_increment,
    ID_EVENT int(18),
    COUNT_START int(18),
    COUNT_END int(18),
...
create table  IF NOT EXISTS b_kit_mailing_unsubscribed (
    ID int not null auto_increment,
...
create table  IF NOT EXISTS b_kit_mailing_undelivered (
    ID int not null auto_increment,
    ACTIVE char(1) not null default 'Y',
    DATE_CREATE datetime null,
    ID_EVENT int(18) not null default '0',
...
create table  IF NOT EXISTS b_kit_mailing_categories (
    ID int not null auto_increment,
    ACTIVE char(1) not null default 'Y',
    DATE_CREATE datetime null,
    NAME text null,
...
create table  IF NOT EXISTS b_kit_mailing_subscribers (
    ID int not null auto_increment,
    ACTIVE char(1) not null default 'Y',
    DATE_CREATE datetime null,
...
create table IF NOT EXISTS b_kit_mailing_subscr_categ
(
    ID int not null auto_increment,    
