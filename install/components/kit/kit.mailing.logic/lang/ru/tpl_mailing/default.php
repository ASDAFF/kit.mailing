                    ...
                    <tbody>
                        <tr>
                            <td width="50%" align="left"  valign="top">
                                <a href="http://#SITE_URL#/?MAILING_MESSAGE=#MAILING_MESSAGE#&utm_source=newsletter&utm_medium=email&utm_campaign=kit_mailing_#MAILING_EVENT_ID#" ><img src="http://#SITE_URL#/bitrix/components/kit/kit.mailing.logic/images/shablon_logo.jpg"  /></a>
                            </td>
            ...
            <td style="vertical-align: top; padding-top: 20px; padding-bottom: 20px; font-size: 16px; font-family:Trebuchet MS; color: #FFFFFF">
               <p style="text-align: center; padding-bottom: 10px; border-bottom: 1px solid #9ccfef ;"><b>Контактные данные</b></p>    
                ...
                <p style="text-align:center;">
                    <a style="color: #FFFFFF" href="http://#SITE_URL#/?MAILING_MESSAGE=#MAILING_MESSAGE#&MAILING_UNSUBSCRIBE=#MAILING_UNSUBSCRIBE#&utm_source=newsletter&utm_medium=email&utm_campaign=kit_mailing_#MAILING_EVENT_ID#">Отписаться от рассылки</a>
                </p>
            </td>
            <td></td>
        </tr>
