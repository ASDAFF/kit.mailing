...
<div id="kit_reg_panel_form_info" style="display: none;">
    ...
    <div class="reg_bottom_pannel_in_wrap">
        <div class="bottom_pannel_in">
            ...
            <form id="kit_reg_panel_form_time_open" method="post" action="#">
...
<script type="text/javascript">
    function kit_modal_time()
    {
        kit_modal_show($('#kit_reg_panel_form_info').html(), 'kit_reg_form');
        $('#kit_reg_panel_form_info').remove();
    }
    ...
    <?/*if(($_COOKIE["MAILING_EMAIL_POPUP_TIME"] != 'Y') && (!empty($_COOKIE["MAILING_EMAIL_POPUP_TIME_FIRST"])) && (mktime() > $_COOKIE["MAILING_EMAIL_POPUP_TIME_FIRST"] + $arParams['MODAL_TIME_SECOND_OPEN'])):*/?>
        //setTimeout(kit_modal_time, 2000);
    ...
    {
        var email = $(".kit_reg_form #kit_reg_panel_form_time_open input[name=EMAIL_TO]").val();
