...
if(CModule::IncludeModule("sale")) {
    ...
    // получим типы плательщиков
    //$arOrderPersonTypeId = array('' => GetMessage('SELECT_PARAM_ALL'));    
    $arOrderPersonTypeId = array();    
    $dbPersonTypeId = CSalePersonType::GetList(Array("SORT"=>"ASC", "NAME"=>"ASC"), Array());
    while($arrPersonType = $dbPersonTypeId->Fetch()){
        $arOrderPersonTypeId[$arrPersonType["ID"]] = '['.$arrPersonType["ID"].'] '.$arrPersonType['NAME'];           
    }
...
$arTemplateParameters["SITE_ID"] = array(    
  ...
  // тип плательщика
$arTemplateParameters["ORDER_FILLTER_PERSON_TYPE_ID"] = array(    
    "PARENT" => "PARAM_ORDER_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_FILLTER"),
    "NAME" => GetMessage('ORDER_FILLTER_PERSON_TYPE_ID_TITLE'),
    "TYPE" => "LIST",
    "VALUES" => $arOrderPersonTypeId,
    "SORT" => "13",
    "MULTIPLE" => 'Y',
    "SIZE" => '4',
);     
  // пользователь
$arTemplateParameters["ORDER_FILLTER_USER_ID"] = array(    
    "PARENT" => "PARAM_ORDER_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_FILLTER"),
    "NAME" => GetMessage('ORDER_FILLTER_USER_ID_TITLE'),
    "TYPE" => "USER_ID",
    "SORT" => "15",
); 
  
  //дата создания
$arTemplateParameters["ORDER_FILLTER_DATE_INSERT"] = array(    
    "PARENT" => "PARAM_ORDER_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_FILLTER"),
...
$arTemplateParameters["ORDER_FILLTER_DATE_INSERT_AGO"] = array(    
  ...
  //дата изменения
$arTemplateParameters["ORDER_FILLTER_DATE_UPDATE"] = array(    
    "PARENT" => "PARAM_ORDER_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_FILLTER"),
    "NAME" => GetMessage('ORDER_FILLTER_DATE_UPDATE_TITLE'),
    "TYPE" => "DATE_PERIOD",
    "SORT" => "30",
);  
$arTemplateParameters["ORDER_FILLTER_DATE_UPDATE_AGO"] = array(    
    "PARENT" => "PARAM_ORDER_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_FILLTER"),
    "NAME" => GetMessage('ORDER_FILLTER_DATE_UPDATE_TITLE'),
    "TYPE" => "DATE_PERIOD_AGO",
...
$arTemplateParameters["ORDER_FILLTER_STATUS"] = array(    
    "PARENT" => "PARAM_ORDER_STATUS_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_STATUS_FILLTER"),
...
$arTemplateParameters["ORDER_FILLTER_DATE_STATUS"] = array(    
    "PARENT" => "PARAM_ORDER_STATUS_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_STATUS_FILLTER"),
...
$arTemplateParameters["ORDER_FILLTER_PAY_SYSTEM_ID"] = array(    
    "PARENT" => "PARAM_ORDER_PAY_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_PAY_FILLTER"),
...
$arTemplateParameters["ORDER_FILLTER_PAYED"] = array(    
  ...
  //дата оплаты заказа     
$arTemplateParameters["ORDER_FILLTER_DATE_PAYED"] = array(    
    "PARENT" => "PARAM_ORDER_PAY_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_PAY_FILLTER"),
    "NAME" => GetMessage('ORDER_FILLTER_DATE_PAYED_TITLE'),
    "TYPE" => "DATE_PERIOD",
    "SORT" => "80",
);  
$arTemplateParameters["ORDER_FILLTER_DATE_PAYED_AGO"] = array(    
    "PARENT" => "PARAM_ORDER_PAY_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_PAY_FILLTER"),
    "NAME" => GetMessage('ORDER_FILLTER_DATE_PAYED_TITLE'),
    "TYPE" => "DATE_PERIOD_AGO",
...
$arTemplateParameters["ORDER_FILLTER_DELIVERY_ID"] = array(    
    "PARENT" => "PARAM_ORDER_DELIVERY_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_DELIVERY_FILLTER"),
  ...
  // доставка разрешена 
$arTemplateParameters["ORDER_FILLTER_ALLOW_DELIVERY"] = array(    
    "PARENT" => "PARAM_ORDER_DELIVERY_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_DELIVERY_FILLTER"),
    "NAME" => GetMessage('ORDER_FILLTER_ALLOW_DELIVERY_TITLE'),
    "TYPE" => "LIST",
    "VALUES" => $arSelectYesNo,
    "SORT" => "100",
...
$arTemplateParameters["ORDER_FILLTER_DATE_ALLOW_DELIVERY"] = array(    
    "PARENT" => "PARAM_ORDER_DELIVERY_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_DELIVERY_FILLTER"),
    "NAME" => GetMessage('ORDER_FILLTER_DATE_ALLOW_DELIVERY_TITLE'),
    "TYPE" => "DATE_PERIOD",
    "SORT" => "110",
);        
$arTemplateParameters["ORDER_FILLTER_DATE_ALLOW_DELIVERY_AGO"] = array(    
    "PARENT" => "PARAM_ORDER_DELIVERY_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_DELIVERY_FILLTER"),
    "NAME" => GetMessage('ORDER_FILLTER_DATE_ALLOW_DELIVERY_TITLE'),
    "TYPE" => "DATE_PERIOD_AGO",
  ...
  //отменен заказ
$arTemplateParameters["ORDER_FILLTER_CANCELED"] = array(    
    "PARENT" => "PARAM_ORDER_CANCELED_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_CANCELED_FILLTER"),
    "NAME" => GetMessage('ORDER_FILLTER_CANCELED_TITLE'),
    "TYPE" => "LIST",
    "VALUES" => $arSelectYesNo,
    "SORT" => "120",
);  
  //дата отмены заказа     
$arTemplateParameters["ORDER_FILLTER_DATE_CANCELED"] = array(    
    "PARENT" => "PARAM_ORDER_CANCELED_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_CANCELED_FILLTER"),
    "NAME" => GetMessage('ORDER_FILLTER_DATE_CANCELED_TITLE'),
    "TYPE" => "DATE_PERIOD",
    "SORT" => "130",
);         
$arTemplateParameters["ORDER_FILLTER_DATE_CANCELED_AGO"] = array(    
    "PARENT" => "PARAM_ORDER_CANCELED_FILLTER",
    "PARENT_NAME" => GetMessage("GROUP_PARAM_ORDER_CANCELED_FILLTER"),
    "NAME" => GetMessage('ORDER_FILLTER_DATE_CANCELED_TITLE'),
    "TYPE" => "DATE_PERIOD_AGO",
