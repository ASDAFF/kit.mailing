                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 0; padding: 10px 0;">
                                    <tr width="100%">
                                        ...
                                        <td width="62%" align="left">
                                            <a href="<?=$item['DETAIL_PAGE_URL']?>?utm_source=newsletter&utm_medium=email&utm_campaign=kit_mailing_#MAILING_EVENT_ID#&MAILING_MESSAGE=#MAILING_MESSAGE#"
                                                target="_blank"
                                        ...
                                        <td width="20%" align="right">
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0; padding:10px 0;">
                                                <tr bgcolor="#000000" style="height:28px;">
                                                    <td>
                                                        <a href="<?=$item['DETAIL_PAGE_URL']?>?utm_source=newsletter&utm_medium=email&utm_campaign=kit_mailing_#MAILING_EVENT_ID#&MAILING_MESSAGE=#MAILING_MESSAGE#" style="font: 13px 'Proxima Nova', Arial, sans-serif;color: #ffffff;text-align: center;text-transform:uppercase;text-decoration:none;line-height:16px;display: block; -webkit-text-size-adjust:none;">
