...
class SubConnectorManager
{
    ...
    {
        $arData['CONNECTOR'] = 'Kit\Mailing\Libsubconnector\MainUser';
        return $arData;
    }
    ...
    public static function onSubConnectorListSaleBuyer($arData)
    {
        if(\Bitrix\Main\Loader::includeModule("sale")){
            $arData['CONNECTOR'] = 'Kit\Mailing\Libsubconnector\SaleBuyer';
        }
        return $arData;
    }    
    ...
    public static function onSubConnectorListFormResult($arData)
    {
        if(\Bitrix\Main\Loader::includeModule("form")){
            $arData['CONNECTOR'] = 'Kit\Mailing\Libsubconnector\FormResult';
        }
        return $arData;
    }    
    ...
    public static function onSubConnectorListSubscriber($arData)
    {
        if(\Bitrix\Main\Loader::includeModule("subscribe")){
            $arData['CONNECTOR'] = 'Kit\Mailing\Libsubconnector\Subscriber';
        }
        return $arData;
    }     
    ...
    public static function getConnectorClassList(array $endpointList = null)
    {
        ...
        $data = array();
        $event = new Event('kit.mailing', 'OnSubConnectorList', array($data), $moduleIdFilter);
        $event->send();      
        ...
        {   
            ...
            {    
                ...
                if(!is_subclass_of($connectorClassName,  '\Kit\Mailing\SubConnector'))
                {
                    continue;
                }
