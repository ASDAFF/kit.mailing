...
namespace Kit\Mailing\LibSubConnector;

use Bitrix\Main\Localization\Loc;

Loc::loadMessages(__FILE__);

class Subscriber extends \Kit\Mailing\SubConnector
{
    /**
    ...
    public function getForm()
    {
        ...
        $rubricInput .= '<option value="" >'.GetMessage('sender_connector_user_select_change').'</option>';
