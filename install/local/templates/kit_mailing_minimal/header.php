...
if(\Bitrix\Main\Loader::includeModule('kit.missshop'))
    $moduleID = 'kit.missshop';
if(\Bitrix\Main\Loader::includeModule('kit.mistershop'))
    $moduleID = 'kit.mistershop';
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0; padding:0;">
                                <tr width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <td width="10%" align="left" style="vertical-align: top; padding-top: 4px;">
                                        <!--<![endif]-->
                                        <img src="<?=$serverName?>/local/templates/kit_mailing_minimal/img/mail_phone.png" alt="" border="0" width="11" height="11" style="display:block;text-decoration:none;outline:none;">
                                        <!--[if !mso]><!-- -->
                                    </td>
                                    <td width="90%" align="left">
                                        ...
                                        <?
                                        if(!$phones)
                                            $phones = explode("\n", file_get_contents($serverName.'/local/templates/kit_mailing_minimal/phones.php'));
                                ...
                                <tr >
                                    <td width="100%">
                                        ...
                                        <a href="<?=$serverName?>" target="_blank" style="color: #000000;text-decoration: none;display: block; -webkit-text-size-adjust:none;">
                                            <img src="<?if($logo) echo $logo; else CMain::IncludeFile('/local/templates/kit_mailing_minimal/logo.php');?>" alt="" border="0" width="195" style="display:block;text-decoration:none; outline:none;">
                                        </a>
                                        <!--[if gte mso 9]>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0; padding:0;">
                                <tr width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <td width="20%" align="right" style="vertical-align: top; padding-top: 6px;">
                                        <!--<![endif]-->
                                        <img src="<?=$serverName?>/local/templates/kit_mailing_minimal/img/mail.png" alt="" border="0" width="13" height="10" style="display:block;text-decoration:none; outline:none;">
                                        <!--[if !mso]><!-- -->
                                    </td>
                                     ...
                                     <td width="80%" align="left" cellpadding="0" cellspacing="0" border="0">
                                         <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:0; padding:0">
                                             <tr cellpadding="0" cellspacing="0" border="0" width="100%">
                                                 <td width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <![endif]-->
                                        <a href="mailto:<?if($email) echo $email; else CMain::IncludeFile('/local/templates/kit_mailing_minimal/email.php');?>" target="_blank" style="font: 16px 'Proxima Nova', Arial, sans-serif;color: #000000;font-weight: bold;text-decoration: none;line-height:21px;display: block;padding: 0 0 0 9px; -webkit-text-size-adjust:none;">
                                            <font color="#000000" size="3" face="Proxima Nova, Arial, sans-serif">
