...
$MESS[$module_id."_OPTION_50"] = "Тема оформления почтового шаблона по умолчанию";
$MESS[$module_id."_OPTION_60"] = "Оптимизация отправки сообщений";
$MESS[$module_id."_OPTION_70"] = "Черный список"; 
...
$MESS[$module_id."_AUTH_GROUPS_TITLE"] = "Группы пользователей кому можно авторизоваться через почтовое сообщение";
...
$MESS[$module_id."_TEMPLATE_MAILING_THEME_DEF_TITLE"] = "Тема оформления по умолчанию"; 
...
$MESS[$module_id."_FILE_LOG_TITLE"] = "Файл логов"; 
$MESS[$module_id."_FILE_LOG_NOTES"] = "Выставьте путь по умолчанию для файла логов почтовых отправлений сервера";
