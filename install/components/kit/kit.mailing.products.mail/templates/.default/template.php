                ...
                <tbody>
                    <tr>                            
                        <td valign="center" align="center" width="140px"  style="padding-top: 10px;">
                            <a style="display: block;" href="<?=$item['DETAIL_PAGE_URL']?>?utm_source=newsletter&utm_medium=email&utm_campaign=kit_mailing_#MAILING_EVENT_ID#&MAILING_MESSAGE=#MAILING_MESSAGE#"><img src="<?=$item['PREVIEW_PICTURE']['src']?>" width="138"></a>
                        </td>
                                
                        <td valign="top" width="305px" style="padding: 35px 30px 0 30px;text-align:left">
                            <a href="<?=$item['DETAIL_PAGE_URL']?>?utm_source=newsletter&utm_medium=email&utm_campaign=kit_mailing_#MAILING_EVENT_ID#&MAILING_MESSAGE=#MAILING_MESSAGE#" style="color:#546f83;font-size:14px"><?=$item['NAME']?></a>
                        </td>
                        ...
                        <td valign="middle" style="text-align:center;padding-top: 15px;">
                            ...
                            <a href="<?=$item['DETAIL_PAGE_URL']?>?utm_source=newsletter&utm_medium=email&utm_campaign=kit_mailing_#MAILING_EVENT_ID#&MAILING_MESSAGE=#MAILING_MESSAGE#" style="margin-top: 20px;display: inline-block;text-decoration:none;background:#b2091b;font-size:16px;color:#fff;padding: 8px 28px">
