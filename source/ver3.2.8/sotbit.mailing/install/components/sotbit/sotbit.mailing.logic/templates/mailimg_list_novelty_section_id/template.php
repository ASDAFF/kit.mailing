...
//START
    ...
    // получим разделы поиска и категории
    // START
    ...
    // получим информация о разделах инфоблока
    // START
    ...
    // получим информацию по новинках
    // START
    ...
    // категории рассылок  получим данные и сформируем сообщения
    // START
    ...
    while($resSubscribers = $dbSubscribers->Fetch()){
        ...
        //если есть пользователь получим данные
        ...
        // добавим новинки категорий в сообщения
